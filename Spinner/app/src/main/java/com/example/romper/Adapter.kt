...
// Definimos nuestra clase Adapter que hereda de ArrayAdapter especializada en objetos tipo "Hada"
class Adapter(context: Context, private val lista: List<Hada>) :
    ArrayAdapter<Hada>(context, 0, lista) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val hada = lista[position]

        // Buscamos los componentes dentro del layout inflado (itemView)
        val imagen = itemView.findViewById<ImageView>(R.id.im)
        ...
        val imagenUri = hada.imagen
        imagen.setImageResource(imagenUri)
        nombre.text = hada.nombre
